...
const Noteitem = (props) => {
    ...
    return (
        <div className="col-md-3 my-2">
            <div className="card mx-2" style={{"border": '1px solid black'}}>
                <div className="card-body">
                    ...
                    <span className="material-symbols-outlined mx-2" role="button" onClick={() => { deleteNote(note._id); props.showAlert("Deleted Successfully", "success") }}>delete</span>
